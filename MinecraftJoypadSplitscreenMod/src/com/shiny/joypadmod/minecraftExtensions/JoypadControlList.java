...
public class JoypadControlList extends GuiScrollingList
{
	...
	public void updateJoyBindings()
	{
		...
		for (KeyBinding key : akeybinding)
		{
			...
			{
				BindingOptions bindCategory = ControllerBinding.mapMinecraftCategory(McObfuscationHelper.getCategory(key));
			...
			if (b.getCategory() != category)
			{
				...
				List<ControllerBinding> otherBindings = ControllerSettings.getMatchingBindings(ControllerBinding.mapMinecraftCategory(category));
