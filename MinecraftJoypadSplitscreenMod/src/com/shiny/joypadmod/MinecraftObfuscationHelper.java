...
// the point of this class is to have a central location for calls to all the Minecraft functions that are currently obfuscated
// due to Forge not being up to date with MCP or MCP not having the latest variable name de-obfuscated
// This is particularly useful in early releases of Forge and less useful as the version stabilizes
// This may help in keeping older Minecraft joypad releases up to date with the latest additions 

// you will note that it is primarily only useful for the functions that are currently obfuscated in Forge 1.7.2 but a central location
